...
var sayingData = {
    ...
    faceBossAt3F:{
        ...
        event:'talkWithNPC("firstWithThiefAt2F");currentFloor = 2;player.x = 7;player.y = 2;player.life = 400;drawFloor();showData();'
    },
    firstWithThiefAt2F:{
        words:["喂！","喂！醒醒","快去探险吧，我先走啦"],
        event:'openDoorAndWall(2,6,1);map[2][6][2].t = "none";drawFloor();'
    }
}
